...
class PersistentStorage : NSObject {
    ...
    var numberOfAppLaunches: Int32 = 0 {
        didSet {
            if numberOfAppLaunches > 0 {
                self.save()
            }
        }
    }
    ...
    required init(coder aDecoder: NSCoder) {
        ...
        self.numberOfAppLaunches = aDecoder.decodeIntForKey("numberOfAppLaunches")
    }
    ...
    func encodeWithCoder(aCoder: NSCoder) {
        ...
        aCoder.encodeInt(self.numberOfAppLaunches, forKey: "numberOfAppLaunches")
    }
